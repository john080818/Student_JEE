 ...
 */
package co.edu.unipiloto.student.controller;

import co.edu.unipiloto.student.entity.Matricula;
import co.edu.unipiloto.student.session.CursoFacadeLocal;
import co.edu.unipiloto.student.session.EstudiantesFacadeLocal;
import co.edu.unipiloto.student.session.MatriculaFacadeLocal;
...
public class matriculaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idStr = request.getParameter("cod_Es");
        String action = request.getParameter("action");

        Matricula matricula = new Matricula(codCurso, idStr);
        switch (action) {
            case "Delete":
                matriculaFacade.remove(matricula);
                break;
            case "Add":
        ...
        request.setAttribute("allStudent", estudiantesFacade.findAll());
        request.setAttribute("allMatricula", matriculaFacade.findAll());
